...
%An important highlight of this comparison is that 
The abstract interpretation using Astr{\'e}e was faster than \ABC for~8 
benchmarks (23\% cases).
%
Among these~8 benchmarks, Astr{\'e}e reported bugs faster than \ABC for~3 
unsafe benchmarks. For the remaining~5 benchmarks, \ABC timed out in 4 cases 
whereas Astr{\'e}e proved all~5 benchmarks faster than \ABC (see the extremen 
right side of Figure~\ref{fig:runtimes}).  
%(benchmark number 10, 14 and 16 in Figure~\ref{fig:runtimes}).  
%
However, Astr{\'e}e reported a total of~7 false alarm out of~34 benchmarks,  
