...
to say that the  first $k$ states are not bad states.  Finally, a property $P$ is \textit{inductive} if $P[X] \wedge \delta[X,X']$ implies $P[X']$.    \tmcmt{Rajdeep - do we ever use the concept of `inductive'?}
