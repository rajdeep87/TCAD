...
Competition 2015, and opencores.org.  Though software verifiers are never 
optimized for RTL verification, experimental evaluation suggests that 
SAT/SMT-based software verification tools are within one order of magnitude 
compared to the bit-level hardware model checkers.  However, the performance 
of abstraction based software verification techniques, such abstract 
interpretation and automata-theoretic trace abstractions, are comparable 
to bit-level harware tools. 
\end{abstract}
