...
at different levels of granularity -- \emph{bit-level}, \emph{word-level} 
and \emph{software-level}.  
...
bit-level hardware model checkers.  However, abstraction based software 
verification techniques, such as abstract interpretation and 
automata-theoretic program verification, though operate 
on an overapproximate representation and hence less precise, but the runtimes
of these tools are comparable to bit-level harware tools.  To the best of our 
knowledge, this is the first exhaustive analysis of most state-of-the-art 
verification techniques employed by verification tools from HWMCC and SV-COMP
for the purposes of RTL verification. 
\end{abstract}
