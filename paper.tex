...
Checking (BMC), $k$-induction, Interpolation and IC3/PDR.  By contrast, 
abstraction-based tools use various convex and non-convex abstract domains
employed by techniques such as Counterexample-guided Abstraction Refinement
(CEGAR) and classical abstract interpretation. 
%
This paper present the comparison of various precise and abstraction-based verification tools 
from the Software Verification Competition (SV-COMP'16), Hardware Model Checking Competition 
(HWMCC'16) and a commercial abstract interpretation tool Astr{\'e}e for the purposes of RTL 
verification.  Experimental evaluation on a total of~34 RTL benchmarks suggest that
Astr{\'e}e with manual guidance is effective for finding complex bugs as well as proving 
unbounded safety of the software netlist designs generated from RTL.  Astr{\'e}e is faster 
than a bit-level hardware model checking tool \textsc{ABC} 
for~23\% (8 out of 34) of our benchmarks.  However, the PDR engine in \ABC performs 
better than Astr{\'e}e for the remaining 26 benchmarks and timeout for 4 benchmarks. 
\end{abstract}

\begin{IEEEkeywords}
Formal verification, Verilog RTL, ANSI-C, SAT, SMT, Abstract Interpretation, 
Symbolic Execution.
\end{IEEEkeywords}
