...
%-------------------------------------------------------------------------------
\subsection{BMC with K-induction} 
%
...
%
%-------------------------------------------------------------------------------
\subsection{Interpolation-based Model Checking} 
%
...
%-------------------------------------------------------------------------------
\subsection{Predicate Abstraction with CEGAR}
%
...
%-------------------------------------------------------------------------------
\subsection{Property Directed Reachability} 
%
...
%
%-------------------------------------------------------------------------------
\subsection{Automata based Trace Abstraction with Interpolants}
%-------------------------------------------------------------------------------
%
