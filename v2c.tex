...
Translation is followed by code-generation, in which the intermediate vectored \tmcmt{Rejdeep: `vectored'? Whart is this?} expressions and translated module items are converted to ANSI-C program syntax.
