...
present a method for synthesis of a Verilog RTL design into an ANSI C program instead, which we
...
Fig.~\ref{ex1} shows an illustrative example. \tmcmt{Rajdeep, please provide a couple of sentences of commentary to explain the example. Also, is this example going to be confusing because the `always' semantics is not translated?}
