...
(blocking, non-blocking) and continuous assignments. Further, Verilog supports 4-valued data types 
such as reg, wire, and integer.  All these non-trivial constructs, combined with 
