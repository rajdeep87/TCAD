...
Translation is followed by code-generation, in which the intermediate \tmcmt{Rejdeep: `vectored'? Whart is this?} \rmcmt{removed} expressions and translated module items are converted to ANSI-C program syntax.
